            ...
            {showWelcome && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <h2 style={{ color: '#495057', marginBottom: '1rem' }}>Hello Admin</h2>
                        <p style={{ color: '#6c757d', marginBottom: '1.5rem' }}>Welcome to the Listings Overview Dashboard</p>
                        ...
                        {Object.keys(productNotifications).length > 0 && (
                            <div style={{ 
                                ...
                                <h5 style={{ color: '#856404', marginBottom: '0.5rem' }}>Action Required:</h5>
                                {Object.values(productNotifications).map((notification, index) => (
                                    <Alert color="warning" key={index} style={{ marginBottom: '0.5rem' }}>
                                        Remove product "{notification.productName}" 
                                                        ...
                                                        {group.listings.map((listing, index) => (
                                                            <Tr key={listing.id}>
                                                                {index === 0 ? (
                                                                    <Td rowSpan={group.listings.length}>
                                                                        ...
                                                                        <div className="text-muted small">
                                                                            Marketplaces: {group.listings.map(l => l.marketplace?.name || 'N/A').join(', ')}
                                                                        </div>
                                                                    </Td>
                                                                ) : null}
                                                                ...
                                                                <Td>
                                                                    ...
                                                                    >
                                                                        {listing.is_active ? 'Mark as sold' : 'Already sold'}
                                                                    </Button>                                          
                                                                </Td>                                               
                                                            </Tr>
                                                        ))}
