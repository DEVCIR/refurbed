...
const MarketplaceTable = (props) => {
  document.title =
    "Marketplaces | Lexa - Responsive Bootstrap 5 Admin Dashboard";
  ...
  const fetchMarketplaceData = async (page = 1) => {
    try {
      setLoading(true);
      const response = await fetch(`${API_BASE_URL}/marketplaces?page=${page}`);
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(`${API_BASE_URL}/marketplaces/${id}`, {
        method: "DELETE",
      });
          ...
          <Card>
            <CardBody>
              ...
              >
                ...
                <Button color="primary" onClick={props.onAddItemClick}>
                            ...
                            <td>
                              <div style={{ display: "flex", gap: "5px" }}>
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() =>
                                    props.onEditItemClick(marketplace)
                                  }
                                >
