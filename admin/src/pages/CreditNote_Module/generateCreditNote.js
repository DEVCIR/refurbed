...
const GenerateCreditNote = (customerData, selectedItems, onBack) => {
  ...
  const handleCreateRMAS = async () => {
    try {
      ...
      const rmasResponse = await fetch(`${API_BASE_URL}/rmas`, {
        method: "POST",
        headers: {
      ...
      if (rmaId) {
        for (const product of selectedProducts) {
          ...
          if (!itemResponse.ok) {
            console.error(
              `Failed to create rma item for inventory_id: ${product.inventory_id}`,
            );
          } else {
          ...
          <Card>
            <CardBody>
                    ...
                    <div className="mb-4 p-3 border rounded shadow-sm ">
                      ...
                      <Row className="mb-3">
                        <Label
                          ...
                          className="col-md-2 col-form-label fw-semibold"
                        >
                          Product Name
                        </Label>
                        <div className="col-md-10">
              ...
              <div className="d-flex justify-content-end mt-4">
                <Button color="primary" className="me-2" onClick={onBack}>
                  Back
                </Button>
                <Button color="success" onClick={handleCreateRMAS}>
                  Create RMAS
                </Button>
              </div>
            </CardBody>
