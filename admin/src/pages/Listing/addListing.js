...
function AddListing({ props, onBackClick }) {
  document.title =
    "Add Listing | Lexa - Responsive Bootstrap 5 Admin Dashboard";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const historyResponse = await fetch(`${API_BASE_URL}/listing-history`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer YOUR_TOKEN_HERE",
      ...
      if (!historyResponse.ok) {
        ...
        throw new Error(
          historyResult.message || "Error creating listing history",
        );
      }
