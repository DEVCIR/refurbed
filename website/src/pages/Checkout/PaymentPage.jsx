...
export default function PaymentPage() {
  ...
  useEffect(() => {
    if (!location.state?.orderData) {
      ...
      if (
        location.state.billingInfo?.firstName &&
        location.state.billingInfo?.lastName
      ) {
        setCardName(
          `${location.state.billingInfo.firstName} ${location.state.billingInfo.lastName}`,
        );
      }
    }
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200 transition-all duration-300 hover:shadow-md">
                ...
                <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-100 flex items-start">
                  ...
                  <p className="text-sm text-blue-700">
                    Your payment information is secured with SSL encryption. We
                ...
                <form onSubmit={handlePaymentSubmit}>
                  <div className="mb-4">
                    ...
                    <div
                      className={`relative ${errors.cardNumber ? "shake" : ""}`}
                    >
                      <input
                        type="text"
                        value={cardNumber}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    <div>
                      ...
                      <div
                        className={`relative ${errors.expiryDate ? "shake" : ""}`}
                      >
                        <input
                          type="text"
                          value={expiryDate}
